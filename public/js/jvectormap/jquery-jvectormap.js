...
(function( $ ){
  ...
  VectorCanvas.prototype = {
    ...
    createCircle: function(config) {
      ...
      if (this.mode == 'svg') {
		//console.log("-----------------------------------");
		//console.log("orig-x>>>>>"+config.x);
		//console.log("orig-y>>>>>"+config.y);
		//console.log("-----------------------------------");
		
		//var text = config.x + 10;
		...
		/*
		node = this.createSvgNode('polyline');
		var x = config.x;
		var y = config.y;
		var point1 =  [x, y];
		var point2 =  [x, y +5];
		var point3 =  [x-5, y+5];
		var icon = point1[0] + ',' + point1[1] + ' ' +
		point2[0] + ',' + point2[1] + ' ' +
		point3[0] + ',' + point3[1];
		node.setAttribute('points', icon);
		*/
  ...
  var WorldMap = function(params) {
    ...
    params.container.mousemove(function(e){
      if (map.label.is(':visible')) {
        map.label.css({
          left: e.pageX-40-map.labelWidth,
          top: e.pageY-30-map.labelHeight
        })
      }
    });
    ...
    if (params.markers) {
      ...
      //$(params.container).delegate('.newPoints', 'mouseover mouseout', function(e){
        var marker = e.target,
      ...
      //$(params.container).delegate('.newPoints', 'click', function(e){
        var marker = e.target;
  ...
  WorldMap.prototype = {
    ...
    applyTransform: function() {
      ...
      if (this.markers) {
	//console.log('REPOSITION MARKERS');
